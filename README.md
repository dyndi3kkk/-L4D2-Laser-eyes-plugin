...
Перед публикацией выберите лицензию.

Рекомендации:

- MIT License, если хотите разрешить свободные модификации и использование
- GPLv3, если хотите, чтобы изменённые версии тоже оставались open-source
- Без лицензии, если не хотите автоматически разрешать переиспользование кода
